...
export const translations = {
  ...
  '繁體中文': {
    ...
    'relation_annotation': '關係標注',
    'relation_entity1': '實體1',
    'relation_entity2': '實體2',
    'relation_name': '關係名稱',
    'relation_list': '關係標注列表',
    'add_relation': '新增關係',
    'export_relations': '導出關係',
    'no_relation_annotations': '暫無關係標注',
    'entity_required_for_relation': '請先完成至少兩個實體標注',
    'select_entity_placeholder': '請選擇實體',
    'select_entities_first': '請選擇兩個實體',
    'select_distinct_entities': '請選擇不同的實體',
    'input_relation_name': '請輸入關係名稱',
    'enter_relation_name': '請輸入關係名稱',
    'no_relations_to_export': '暫無關係可導出',
    'add_relation_failed': '新增關係失敗',
    'delete_relation_failed': '刪除關係失敗',
    'export_relation_failed': '導出關係失敗',
    'adding': '新增中...',
    'exporting': '導出中...',
  ...
  'English': {
    ...
    'no_relation_annotations': 'No relations yet',
    'entity_required_for_relation': 'Annotate at least two entities first',
    'select_entity_placeholder': 'Select entity',
    'select_entities_first': 'Please select two entities',
    'select_distinct_entities': 'Please select different entities',
    'input_relation_name': 'Enter a relation name',
    ...
    'export_relation_failed': 'Failed to export relations',
    'adding': 'Adding...',
    'exporting': 'Exporting...',
